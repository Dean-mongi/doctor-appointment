...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['topScheduledDoctors'] = Doctor::withCount('appointments')->orderBy('appointments_count', 'desc')->take(5)->get();
        $data['pharmacies'] = Pharmacy::with('patient')->latest()->take(10)->get();
        $data['topPatients'] = Patient::withCount('appointments')->orderBy('appointments_count', 'desc')->take(5)->get();
        $data['recentAppointments'] = Appointment::with(['doctor', 'patient'])->latest()->take(10)->get();
        ...
        if ($user->hasRole('super_admin')) {
            ...
            $data['topDoctors'] = Doctor::withCount('appointments')->orderBy('appointments_count', 'desc')->limit(5)->get();
        }
