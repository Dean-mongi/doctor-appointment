...
<html lang="en">
    ...
    <body class="loading authentication-bg" data-layout-config='{"leftSideBarTheme":"dark","layoutBoxed":false, "leftSidebarCondensed":false, "leftSidebarScrollable":false,"darkMode":false, "showRightSidebarOnStart": true}'>
                        ...
                        <div class="card">
                            ...
                            <div class="card-header pt-4 pb-4 text-center bg-primary">
                                <div style="display:flex;align-items:center;justify-content:center;gap:14px;">
                                    <div style="width:48px;height:48px;border-radius:14px;background:#0ea5e9;display:flex;align-items:center;justify-content:center;">
                                        <i class="fas fa-user-md" style="color:#fff;font-size:22px;"></i>
                                    </div>
                            ...
                            <div class="card-body p-4">
                                ...
                                <!-- Using Laravel Blade for form and validation -->
                                <form method="POST" action="{{ route('login') }}">
                                    @csrf

                                    <div class="form-group">
                                        <label for="email">Email address</label>
                                        <input class="form-control" name="email" type="email" id="email" required placeholder="Enter your email" :value="old('email')" autofocus autocomplete="username">
                                    </div>
        ...
        <script>document.write(new Date().getFullYear())</script> © Dean john.
        </footer>
