...
.avatar-lg {
    ...
    <body class="loading" data-layout-config='{"leftSideBarTheme":"light","layoutBoxed":false, "leftSidebarCondensed":false, "leftSidebarScrollable":false,"darkMode":false, "showRightSidebarOnStart": true}'>
        ...
        <div id="preloader">
            <div id="status">
                <div class="bouncing-loader"><div ></div><div ></div><div ></div></div></div></div>
            </div>
        </div>
        <!-- End Preloader-->
        <!-- Begin page -->
            ...
            <div class="left-side-menu">
               ...
               <br>
                ...
                <a href="{{ route('dashboard')}}" class="logo text-center logo-light">
                    ...
                    <span class="logo-sm">
                        <img src="{{ asset('assets/images/logo_sm.png')}}" alt="" style="height: 100px;">
                    </span>
                </a>
                                    ...
                                    <div style="max-height: 230px;" data-simplebar>
                                        ...
                                        @forelse($recentNotifications as $notification)
                                            <a href="{{ route('notifications.index') }}" class="dropdown-item notify-item">
                                                ...
                                                <p class="notify-details">{{ $notification->data['title'] ?? 'Notification' }}
